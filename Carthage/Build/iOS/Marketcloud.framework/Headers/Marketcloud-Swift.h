...
SWIFT_CLASS("_TtC11Marketcloud4HTTP")
...
@interface HTTP (SWIFT_EXTENSION(Marketcloud)) <NSURLSessionTaskDelegate, NSURLSessionDataDelegate>
...
/**
  ...
  \endcode
*/
SWIFT_CLASS("_TtC11Marketcloud10HTTPResult")
...
@interface NSURLResponse (SWIFT_EXTENSION(Marketcloud))
@end
